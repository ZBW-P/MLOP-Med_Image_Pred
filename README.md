...
| **Brain Tumor Detection**    | A curated dataset of human brain MRI images aimed at facilitating the development of deep learning models for brain tumor detection, classification, and localization. The dataset includes 7023 MRI images categorized into four classes: **glioma**, **meningioma**, **pituitary tumor**, and **no tumor**. Data was collected from **figshare**, **SARTAJ**, and **Br35H** datasets. Due to categorization issues in the SARTAJ glioma images, only accurately labeled images from figshare were used. This dataset supports multi-task CNN-based classification and segmentation tasks, including tumor type, grade, and location.([kaggle website](https://www.kaggle.com/datasets/masoudnickparvar/brain-tumor-mri-dataset/data)) | Licensed under **CC0: Public Domain** ([CC0 License](https://creativecommons.org/publicdomain/zero/1.0/)). Free to use without restrictions or attribution. If helpful, consider upvoting or citing the dataset authors on Kaggle. |
