...
if __name__ == '__main__':
    ...
    data_transforms2=transform_medical()
    output_base = r"C:\Users\26435\Desktop\FF-Machine_Learning\FF_OPML\Proj\dataset_split"

        # Create datasets using ImageFolder, which assumes data is organized in subfolders
    train_dataset = datasets.ImageFolder(os.path.join(output_base, 'train'), transform=data_transforms2)
    test_dataset = datasets.ImageFolder(os.path.join(output_base, 'test'), transform=data_transforms2)
    val_dataset = datasets.ImageFolder(os.path.join(output_base, 'val'), transform=data_transforms2)
